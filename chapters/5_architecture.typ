...
Il database MySQL si compone di sette tabelle con responsabilità ben definite (@schema_database).
...
Il frontend, essendo completamente client-side con file statici (HTML, CSS, JavaScript), può essere servito da web server replicati o #gl("cdn") per ridurre latenza e distribuire il carico.
